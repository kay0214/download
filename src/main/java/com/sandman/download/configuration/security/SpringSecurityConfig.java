...
/*        http
        ...
        http
                ...
                .and()
                .formLogin()
                .loginProcessingUrl("/api/sandman/v1/user/login")//登录请求拦截
                .successForwardUrl("/api/sandman/v1/user/success")//登录成功
                .failureForwardUrl("/api/sandman/v1/user/error")//登录失败页面
                .and()
                .logout()
                .logoutUrl("/api/sandman/v1/user/logout").permitAll()//登出请求拦截
